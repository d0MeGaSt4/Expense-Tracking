        ...
        <dl class="dl-horizontal">
            ...
            <div class="center">
                ...
                <div class="button-container ">
                    <form  ACTION="RatifyClaim?claimid=<%=c.getClaimid()%>&i=1" METHOD="post">
                        <div>
                            <button  type="submit" class="btn btn-success ">Approve Claim</button>
                        </div>
                    </form>
                    <form  ACTION="ManagerComment.jsp?claimid=<%=c.getClaimid()%>" METHOD="post">
                        <div>
                            <button  type="submit" class="btn btn-info ">Update Claim </button>
                        </div>
                    </form>
                    <form  ACTION="RatifyClaim?claimid=<%=c.getClaimid()%>&i=2" METHOD="post">
                        <div>
