...
<html>
    ...
    <body>   
        ...
        <form NAME="frmLogin" ACTION="UpdateServlet" METHOD="post" id="claim-form" >
            <fieldset>
                ...
                <div class="text-center">
                    <label class="text-center" for="txtClaimid">Claim Id</label>
                    <div class="text-center">
                        <input type="text" id="txtClaimid" name ="txtClaimid" placeholder="Claim Id" value=<%=claimid%> readonly>
                    </div>
                </div>
                <div class="text-center">
